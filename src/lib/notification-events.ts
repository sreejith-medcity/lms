...
export const NOTIFICATION_EVENTS: { group: string; events: NotificationEvent[] }[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { key: 'fee.reminder', label: 'A fee reminder for their child', who: 'The linked parents, on the same schedule as the learner, once switched on under Notices', live: true },
  ...
  },
  {
    ...
    events: [
      ...
      { key: 'report_card.issued', label: 'A report card was sent', who: 'The learner, and the linked parents', live: true },
      { key: 'result.published', label: 'A result was published', who: 'The linked parents of everyone on the sheet, once the Branch Head approves it', live: true },
