...
export const SETTINGS: SettingDef[] = [
  ...
  {
    key: 'website.heroKicker',
    group: 'website',
    label: 'The small line above the headline',
    help: 'Three or four words, spaced out, setting up the headline. Blank leaves it off.',
    kind: 'text',
    default: 'Learn • Practice • Grow',
    live: true,
  },
  {
    key: 'website.heroScript',
    group: 'website',
    label: 'The handwritten line beside the photograph',
    help: 'A short phrase in a handwriting face, top right of the picture, on wide screens only. Blank leaves it off.',
    kind: 'text',
    default: 'Learn today, build tomorrow',
    live: true,
  },
  {
    key: 'website.heroCaption',
    group: 'website',
    label: 'The card on the photograph',
    help: 'A title and one line, separated by a vertical bar: "LMS inauguration | A brighter future for learners." Blank leaves the photograph plain.',
    kind: 'text',
    default: '',
    placeholder: 'LMS inauguration | A brighter future for learners.',
    live: true,
  },
  {
    key: 'website.heroHighlights',
    group: 'website',
    label: 'The four claims under the hero',
    help: 'One a line, as "Live Classes | Learn from experts". Four at most, and the fifth is ignored rather than wrapped onto a second row. Blank leaves the strip off.',
    kind: 'text',
    multiline: true,
    default:
      'Live Classes | Learn from experts\nMock Tests | Practice with confidence\nFlexible Learning | Learn anytime, anywhere\nCareer Support | Guidance for a brighter tomorrow',
    live: true,
  },
  {
