...
export const LEARNER_NAV_ITEMS = [
  ...
  { key: 'tests', label: 'Mock tests', href: '/learn/tests' },
  ...
  { key: 'rewards', label: 'Rewards', href: '/learn/rewards' },
...
export const DEFAULT_LEARNER_NAV: LearnerNavKey[] = ['learning', 'calendar', 'assignments', 'revise', 'practice', 'tests', 'purchases', 'card', 'explore'];
